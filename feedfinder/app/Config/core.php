 ...
 */
	Configure::write('Security.salt', 'xRLOVhl1j7h6p96hN22rQ7tKE4HN=2JwuLqY|-n^YR70yCCfRax94|1UYJ5');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '54769302357453542496749683645');
