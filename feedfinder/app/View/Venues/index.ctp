...
<div class="container">
    ...
    <div class="page-header">
        ...
        <h4>
            <input type="hidden" class="rating" value=<?php echo $venue_rating[0]['average_rating']; ?> data-readonly/>
        </h4>
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col2">
            ...
            <a href=<?php echo Router::url($this->here, true) . '?rating_low=4&rating_high=6'; ?> id='excellent-link'
        ...
        <div class="col-sm-4 col3">
            ...
            <div class="">
                Comfort
                <br>
                <input id='comfort-rating' type="hidden" class="rating" value=value='0' data-readonly/>
            </div>
            <br>
            ...
            <div class="">
                ...
                <input id='cleanliness-rating' type="hidden" class="rating" value=value='0' data-readonly/>
            </div>
            <br>
            ...
            <div class="">
                ...
                <input id='privacy-rating' type="hidden" class="rating" value=value='0' data-readonly/>
            </div>
            <br>
            ...
            <div class="">
                ...
                <input id='baby-fac-rating' type="hidden" class="rating" value='0' data-readonly/>
            </div>
            <div class="">
                Average spend
                <br>

                <input id='average-spend-rating' type="hidden" class="rating" value='0' data-readonly/>
            </div>
