...
echo $this->Html->script('https://cdn.rawgit.com/dreyescat/bootstrap-rating/master/bootstrap-rating.min.js',array('inline' => false));
echo $this->Html->script('https://cdn.rawgit.com/botmonster/jquery-bootpag/master/lib/jquery.bootpag.min.js',array('inline' => false));
