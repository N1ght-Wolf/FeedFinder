<form role="form" id='places-map-form' class="form-horizontal">
    <!--        select for the time-->
...
<!--    start of heat map select-->
    <div class="form-group">
        ...
        <select class="form-control">
            <option value='venues_interq_admin_one'>County</option>
            <option value='venues_interq_ukadminthree'>S.O.A (Super Output Area)</option>
        </select>
    </div>
