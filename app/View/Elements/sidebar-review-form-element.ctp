<form role="form" id='review-map-form' class="form-horizontal">
    <!--        select for the time-->
...
<!--    start of heat map select-->
    <div class="form-group">
        ...
        <select class="form-control">
            <option value='review_interq_adminone'>County</option>
            <option value='review_interq_ukadminthree'>S.O.A (Super Output Area)</option>
        </select>
    </div>
