...
class Soa extends Model
{
    ...
    public function updateReview(){
        $Review = new Review();
        $fields = array('Venue.soa_id','count(Review.review_text) as count');
        $group = array('Venue.soa_id');
        $conditions = array();
    ...
    public function updateVenue(){
        $Venue = new Venue();
        $fields = array('Venue.soa_id','count(*) as count');
        $group = array('Venue.soa_id');
        $conditions = array();
    ...
    public function updatePgTable($results, $column_name){
        ...
        foreach ($results as $result => $value) {
            ...
            $id = $value['Venue']['soa_id'];
            $count = $value['0']['count'];
            if (isset($id) && isset($count)) {
                $saveMany[] = array('Soa' => array('id' => $id, $column_name => $count));
            }
        }
        //print_r($saveMany);
    ...
    {  
        ...
        $result = $this->find('first',array(
            ...
            'fields'=> array($column_name,'wd14nm AS location_name')
            ));
        return $result;
    }
    ...
    public function updateSoaId(){
        ...
        $longitude=0;
        $results = $Venue->find('all',array(
            'conditions'=>array('Venue.soa_id'=> null),
